...
<!-- TOC -->autoauto- [서블릿 컨테이너, 스프링부트 동작 과정](#서블릿-컨테이너-스프링부트-동작-과정)auto- [서블릿 컨테이너](#서블릿-컨테이너)auto- [서블릿 구현](#서블릿-구현)auto    - [Servlet](#servlet)auto    - [GenericServlet](#genericservlet)auto    - [HttpServlet](#httpservlet)auto    - [서블릿 실행순서](#서블릿-실행순서)auto- [Spring boot와 Servlet](#spring-boot와-servlet)auto    - [스프링 부트 실행과정](#스프링-부트-실행과정)auto    - [클라이언트 요청으로부터 DispatchServlet의 전체 흐름](#클라이언트-요청으로부터-dispatchservlet의-전체-흐름)auto    - [Application context](#application-context)autoauto<!-- /TOC -->
